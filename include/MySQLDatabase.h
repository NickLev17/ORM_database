...
/**
 * @brief class MySQLDatabase
 * Представляет реализацию интерфейса Database для реализации ORM подхода при взаимодействии с базой данных MySQL.
 *
 */
class MYLIB_API MySQLDatabase : public Database
{
    /**
     * Уникальный указатель на объект подключения к MySQL.
     * Управляет временем жизни соединения автоматически.
     */
...
public:
     ...
     *@param _username имя пользователя для подключения к базед данных.
     *@param _password пароль для подключения к базе данных.
     */
